...
class TestContractEndpoints:
    ...
    def test_upload_contract_success(self, client: TestClient, auth_headers, sample_pdf):
    ...
    def test_upload_contract_unauthorized(self, client: TestClient, sample_pdf):
    ...
    def test_list_contracts(self, client: TestClient, auth_headers, sample_pdf):
    ...
    def test_get_contract(self, client: TestClient, auth_headers, sample_pdf):
    ...
    def test_get_contract_status(self, client: TestClient, auth_headers, sample_pdf):
    ...
    def test_get_contract_analysis_not_ready(self, client: TestClient, auth_headers, sample_pdf):
